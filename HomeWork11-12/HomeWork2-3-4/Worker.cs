...
namespace HomeWork2_3_4
{
    public class Worker
    {
        ...
        private string[] namePassengers = { "Алкоголик", "Наркоман", "Тунеядец", "Футболист", "Проститутка", "Сутенер", "Депутат", "Студент академии ТОП", "Гребанный преподаватель", "Самая лучшая преподавательница" };
